...
var_minutes <- (var_seconds-seconds) / 60

minute <- ifelse(var_minutes == 1, "minute", "minutes")
second <- ifelse(seconds == 1, "second", "seconds")

cat(var_seconds, " seconds is ", var_minutes, " ", minute, " and ", seconds, " ",  second, ".\n", sep = "")
...
cat(i, " squared is ", i*i, ",", " and is the first number whose square exceeds ", numeric, sep = "")
```
